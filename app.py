...
def call_gemini_ai(prompt, system_prompt):
    ...
    # Updated to the stable gemini-1.5-flash model to resolve the 404 error
    ...
    return f"Connection Failed. {last_error if last_error else 'Check network or API configuration.'}"
...
def create_pdf(data_dict, ai_text=""):
    ...
    if ai_text:
        ...
        try:
            ...
            clean_text = "AI insight generated (Incompatible characters removed for PDF)."
