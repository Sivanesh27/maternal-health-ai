...
def call_gemini_ai(prompt, system_prompt):
    ...
    # Refined list of the most stable model identifiers. 
    # 'gemini-1.5-flash' is the most widely supported model for the free tier.
    models_to_try = [
        ("v1", "gemini-1.5-flash"),
    ...
    for version, model_name in models_to_try:
        ...
        # Merging instructions into the user prompt for maximum compatibility.
...
st.markdown("""
    ...
    /* Fix Button Text Visibility - Force White Text */
    .stButton>button {
    ...
    /* Force metrics and subheaders to stay dark/visible */
